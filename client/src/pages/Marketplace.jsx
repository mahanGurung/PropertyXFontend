...
const Marketplace = () => {
  ...
  if (isLoading && !nftListings.length && !userNfts.length) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-900/80 via-gray-900/50 to-gray-900/30 mx-auto px-4 sm:px-6 lg:px-8 py-8">
  ...
  return (
    <div className="bg-gradient-to-b from-gray-900/80 via-gray-900/50 to-gray-900/30 min-h-screen px-24 mx-auto sm:px-6 lg:px-8 py-8">
      ...
      >
        <TabsList className="grid grid-cols-3 max-w-xl mx-auto mb-8 bg-gray-800/80 border border-gray-700/50 rounded-lg p-1">
          <TabsTrigger 
            value="browse" 
            className={`py-2 px-4 ${activeTab === 'browse' ? 'bg-gradient-to-r from-teal-500 to-teal-600 text-white' : 'bg-transparent text-gray-400 hover:text-gray-300'} rounded-md transition-all duration-300`}
          >
            <i className="fas fa-store mr-2"></i> Browse
          </TabsTrigger>
          <TabsTrigger 
            value="my-nfts" 
            className={`py-2 px-4 ${activeTab === 'my-nfts' ? 'bg-gradient-to-r from-teal-500 to-teal-600 text-white' : 'bg-transparent text-gray-400 hover:text-gray-300'} rounded-md transition-all duration-300`}
          >
            <i className="fas fa-image mr-2"></i> My APTs
          </TabsTrigger>
          <TabsTrigger 
            value="my-listings" 
            className={`py-2 px-4 ${activeTab === 'my-listings' ? 'bg-gradient-to-r from-teal-500 to-teal-600 text-white' : 'bg-transparent text-gray-400 hover:text-gray-300'} rounded-md transition-all duration-300`}
          >
                    ...
                    <div key={listing.id} className="bg-gradient-to-b from-gray-800/50 to-gray-800/80 rounded-lg shadow-lg overflow-hidden border border-gray-700/30 hover:border-teal-400/50 transition-all duration-300 hover:shadow-teal-500/20">
                      ...
                      <div className="p-4">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="px-2 py-1 bg-gray-700/50 rounded text-xs font-medium text-gray-300 capitalize">
                            {listing.assetType}
                          </div>
                        </div>
                        <p className="mt-2 text-sm text-gray-300 line-clamp-2">{listing.description}</p>
                        
                        <div className="mt-4 grid grid-cols-2 gap-4 mb-4">
                          <div>
                            <p className="text-xs text-gray-400">Valuation</p>
                            <p className="text-sm font-semibold text-gray-100">{listing.valuation}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-400">Token Price</p>
                            <p className="text-sm font-semibold text-gray-100">{listing.tokenPrice}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-400">Token Supply</p>
                            <p className="text-sm font-semibold text-gray-100">{listing.tokens.split(' ')[0]}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-400">APR</p>
                            <p className="text-sm font-semibold text-teal-400">{listing.apr}</p>
                          </div>
                        </div>
          ...
          {!connected ? (
            ...
            <>
              {userNfts.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {userNfts.map((nft) => (
                    <div key={nft.id} className="bg-gradient-to-b from-gray-800/50 to-gray-800/80 rounded-lg shadow-lg overflow-hidden border border-gray-700/30 hover:border-teal-400/50 transition-all duration-300 hover:shadow-teal-500/20">
                      <div className="h-48 bg-gray-700/50 overflow-hidden">
                        <img 
                          src={nft.imageUrl} 
                          alt={nft.name}
                      ...
                      <div className="p-4">
                        ...
                        <p className="mt-2 text-sm text-gray-300 line-clamp-2">{nft.description}</p>
                        
                        <div className="mt-4 grid grid-cols-2 gap-4 mb-4">
                          <div>
                            <p className="text-xs text-gray-400">Valuation</p>
                            <p className="text-sm font-semibold text-gray-100">{nft.valuation}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-400">Token Price</p>
                            <p className="text-sm font-semibold text-gray-100">{nft.tokenPrice}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-400">Token Supply</p>
                            <p className="text-sm font-semibold text-gray-100">{nft.tokens.split(' ')[0]}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-400">APR</p>
                            <p className="text-sm font-semibold text-teal-400">{nft.apr}</p>
                          </div>
                        </div>
                    ...
                    <div key={listing.id} className="bg-gradient-to-b from-gray-800/50 to-gray-800/80 rounded-lg shadow-lg overflow-hidden border border-gray-700/30 hover:border-teal-400/50 transition-all duration-300 hover:shadow-teal-500/20">
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex space-x-2">
                          <Button
                            variant="outline"
                            className="flex-1 border-red-500/50 text-red-400 hover:bg-gray-700/50 hover:border-red-400/50 transition-all duration-300"
          ...
          {selectedNft && (
            <div className="py-4">
              ...
              <div className="grid gap-4">
                <div>
                  <label htmlFor="listing-price" className="block text-sm font-medium text-gray-300 mb-1">Listing Price</label>
                  <div className="mt-1 relative rounded-md shadow-sm">
                    <Input
                      ...
                      className="pr-16 block w-full bg-gray-700/50 border-gray-600/50 text-gray-100 focus:ring-teal-500 focus:border-teal-500"
                      placeholder="0.00"
                    />
                    <div className="absolute inset-y-0 right-0 flex items-center">
                      ...
                      >
                        <SelectTrigger className="bg-gray-700/50 border-gray-600/50 text-gray-100 pr-3 text-sm w-[70px]">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="bg-gray-800 border-gray-700/50 text-gray-100">
                ...
                <div>
                  <label htmlFor="expiry-days" className="block text-sm font-medium text-gray-300 mb-1">Listing Duration</label>
                  <Select 
                    value={listingDetails.expiryDays.toString()} 
                    onValueChange={(v) => setListingDetails({...listingDetails, expiryDays: parseInt(v)})}
                  >
                    <SelectTrigger className="w-full bg-gray-700/50 border-gray-600/50 text-gray-100 focus:ring-teal-500 focus:border-teal-500">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-gray-800 border-gray-700/50 text-gray-100">
                ...
                <div>
                  <label htmlFor="target-buyer" className="block text-sm font-medium text-gray-300 mb-1">
                  ...
                  <Input
                    ...
                    className="block w-full bg-gray-700/50 border-gray-600/50 text-gray-100 focus:ring-teal-500 focus:border-teal-500"
              ...
              <div className="bg-gray-700/50 p-4 rounded-md mt-6">
                <div className="flex justify-between mb-2">
                  <span className="text-sm text-gray-300">Marketplace Fee (2.5%)</span>
